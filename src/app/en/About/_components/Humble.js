...
const Humble = () => {
  ...
  return (
    ...
    <h3 className='heading-desktop-h3' ref={whiteHeaderRef}>From Humble Beginnings to Fitness Icons - Our Inspiring Journey</h3>
</div>

<div className='blog-header-wrapper'>
    <h3 className='text-medium-normal' ref={whiteTextRef}>
        With years of experience and knowledge, we have transformed countless lives. Our clients trust us because we practice what we preach. This commitment has also led to numerous successes in international competitions.
    </h3>
</div>
