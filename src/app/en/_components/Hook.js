...
<p className='text-regular-semibold black section-indicator alignself text-regular-semibold lighter smooth' ref={squareRef1}>Sponsors</p>
<h3 className='heading-desktop-h3 black' ref={headerRef1}>Sponsors and Exclusive Discounts</h3>
<p className='text-medium-normal black' ref={paragraphRef1}>Discounts just for you.</p>
</div>
    ...
    <p className='text-regular-semibold black section-indicator alignself text-regular-semibold lighter' ref={squareRef}>Start Now!</p>

    <h3 className='heading-desktop-h3 black' ref={headerRef}>Choose your program today and start achieving your goals!</h3>
    <p className='text-medium-normal black' ref={paragraphRef}>Tailored programs to meet your needs.</p>
