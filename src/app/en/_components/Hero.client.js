...
const Hero = () => {
    ...
    const swiperWrapperRef1 = useRef(null);
    ...
    useGSAP(() => {
        ...
        ScrollTrigger.create({
            ...
            onEnter: () => {
                ...
                swiperWrapperRef1.current.classList.add('swiper-light');
            ...
            onLeaveBack: () => {
                ...
                swiperWrapperRef1.current.classList.remove('swiper-light');
                    ...
                    <div className='heros-overflow' ref={herosRef}>
                        <div className='hero-left'>
                            <div className='hero-text-wrapper'>
                                <h1 className='hero-header'>Transform your life: embrace health and vitality!</h1>
                    ...
                    <div className='tmp-about-left'>
                        <div className='left-wrapper'>
                            <div className='tmp-about-left-headers'>
                                <p className='black section-indicator alignself text-regular-semibold'>Guaranteed Results</p>

                                <h3 className='heading-desktop-h3' ref={headerRef}>Get to Know Us! We Are Personal Trainers with Proven Success</h3>
                                <p className='text-medium-normal' ref={textRef}>
                                    With years of experience and numerous client transformations, we are dedicated to helping you achieve your fitness goals.
                                </p>
                            </div>
                            ...
                            <div className='left-row'>
                                <div className='left-row-cell'>
                                    <div className='left-row-cell-wrapper' ref={rowRef}>
                                        ...
                                        <h6 className='heading-desktop-h6 highlighted-header'>We Offer Expertise</h6>
                                        <p className='text-regular-normal'>Weight loss, muscle building, functional training, and more.</p>
                                    </div>
                                </div>

                                <div className='left-row-cell'>
                                    <div className='left-row-cell-wrapper' ref={rowReff}>
                                        <img src="/images/trophy.svg" className='relume-icon' alt='heroes' />
                                        <h6 className='heading-desktop-h6 highlighted-header'>Achieving Your Goals</h6>
                                        <p className='text-regular-normal'>We have helped nearly 100 clients achieve their fitness milestones.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div className='header-wrapper'>
        <p className='text-regular-semibold black section-indicator alignself text-regular-semibold'>Transformations</p>
    </div>
    <div className='header-wrapper'>
        <h3 className='heading-desktop-h3'>See for Yourself!</h3>
    </div>
    <div className='header-wrapper'>
        <h3 className='text-medium-normal'>Browse through numerous successful transformations.</h3>
    </div>
</div>
    ...
    <div className='one-first-left'>
        <div className='first-left-wrapper'>
            <h3 className='heading-desktop-h3' ref={headerRef1}>Transform your body and mind with our guidance and support!</h3>
        </div>
    </div>
    <div className='one-first-right'>
        <div className='one-right-upper'>
            <p className='text-medium-normal' ref={textRef1}>
                Our programs offer a holistic approach to fitness, helping you achieve physical strength, mental clarity, and a balanced lifestyle.
            </p>
        </div>
            ...
            <div className='left-row'>
                <div className='left-row-cell'>
                    <div className='left-row-cell-wrapper' ref={rowRef1}>
                        <img src="/images/hearth.svg" className='relume-icon' alt='heroes' />
                        <h6 className='heading-desktop-h6 highlighted-header'>Physical Benefits</h6>
                        <p className='text-regular-normal'>
                            Build lean muscle, increase endurance, and improve your overall fitness level.
                        </p>
                    </div>
                </div>
                ...
                <div className='left-row-cell'>
                    <div className='left-row-cell-wrapper' ref={rowReff1}>
                        <img src="/images/brain.svg" className='relume-icon' alt='heroes' />
                        <h6 className='heading-desktop-h6 highlighted-header'>Mental Benefits</h6>
                        <p className='text-regular-normal'>
                            Boost self-confidence, reduce stress, and enhance cognitive functions.
                        </p>
                    </div>
                </div>
            </div>
...
<div className='animated-line'>
    ...
    <div className='circle circle1'><span className='circle-text'>Start Training</span></div>
    <div className='line line2'></div>
    <div className='circle circle2'><span className='circle-text'>Achieve Goals</span></div>
    <div className='line line3'></div>
    <div className='circle circle3'><span className='circle-text'>Build Confidence</span></div>
    <div className='line line4'></div>
                ...
                <div className='prednosti-one' ref={shadowRef}>
                    <div className='on-right desktop'>
                        <video
                            src="/Videos/11.mp4"
                            autoPlay
                            muted
    ...
    <p className='black section-indicator alignself text-regular-semibold smooth' ref={wordRef}>1-on-1 Benefits</p>

    <h3 className='heading-desktop-h3 smooth' ref={headerRef2}>Advantages of 1-on-1 Training</h3>
    <div className='one-bullets-row'>

        <div className='one-bullet'>
            <div className='one-bullet-wrapper'>
                <img src="/images/user-voice.svg" className='relume-icon smooth' alt='heroes' ref={relRef1} />
                <h6 className='heading-desktop-h6 highlighted-header smooth' ref={hRef1}>Immediate Feedback</h6>
                <p className='text-regular-normal smooth' ref={pRef1}>
                    We provide encouragement and motivation during training, allowing for more intense workouts and better results.
                </p>
            </div>
        </div>
        <div className='one-bullet'>
            <div className='one-bullet-wrapper'>
                <img src="/images/user-check.svg" className='relume-icon smooth' alt='heroes' ref={relRef2} />
                <h6 className='heading-desktop-h6 highlighted-header smooth' ref={hRef2}>Proper Execution</h6>
                <p className='text-regular-normal smooth' ref={pRef2}>
                    Ensuring correct exercise form with instant corrections for improper techniques.
                </p>
            </div>
        </div>
        ...
        <div className='one-bullet'>
            <div className='one-bullet-wrapper'>
                <img src="/images/laugh.svg" className='relume-icon smooth' alt='heroes' ref={relRef3} />
                <h6 className='heading-desktop-h6 highlighted-header smooth' ref={hRef3}>Great Company</h6>
                <p className='text-regular-normal smooth' ref={pRef3}>
                    Along with challenging workouts, enjoy plenty of laughter and fun.
                </p>
            </div>
        </div>
    </div>
            ...
            <div className='go-white-div' ref={whiteRef}>
                ...
                <div className='white-row'>
                    {/*<div className='white-right desktop' ref={swiperWrapperRef}>
...
<div className='white-left' ref={leftRef}>
    <p className='text-regular-semibold black section-indicator smooth' ref={whiteSmallRef}>Start Now!</p>
    <h3 className='heading-desktop-h3 smooth' ref={whiteHeaderRef}>
        We offer a comprehensive range of services designed to meet your needs and desires!
    </h3>

    <h3 className='text-medium-normal smooth' ref={whiteTextRef}>
        Focus on your health and well-being with a wide selection of tailored solutions.
    </h3>

    <div className='buttoin'>
        <HoverButton
            text="Read More"
            onClick={() => handleNavigation('en/Plans')}
        />
    </div>
</div>

                    <div className='white-right ' ref={swiperWrapperRef1}>
                        <div className='white-swiper'>
                        <Swiper
    modules={[Pagination]}
    slidesPerView={1}
...
>
    <SwiperSlide>
        <img alt="item-1" className="white-img" src="/images/z3.webp" />
        <h4 className="program-header black hmargin w90">1-on-1 Training</h4>
        <h3 className="text-medium-normal black w90">A personalized approach to achieve your goals faster.</h3>
        <div className="error-row w90">
            <img src="/images/error-circle.svg" className="small-icon" alt="heroes" />
            <p className="error-message">Live training does not include a gym membership!</p>
        </div>
    </SwiperSlide>

    <SwiperSlide>
        <img alt="item-2" className="white-img" src="/images/z2.webp" />
        <h4 className="program-header black align-left hmargin w90">Partner Training</h4>
        <h3 className="text-medium-normal black align-left w90">Train with a friend or your significant other.</h3>
        <div className="error-row w90">
            <img src="/images/error-circle.svg" className="small-icon" alt="heroes" />
            <p className="error-message">Live training does not include a gym membership!</p>
        </div>
    ...
    <SwiperSlide>
        <img alt="item-3" className="white-img" src="/images/z4.webp" />
        <h4 className="program-header black align-left hmargin w90">Online Coaching</h4>
        <h3 className="text-medium-normal black align-left w90">A program you can follow anywhere.</h3>
    </SwiperSlide>

    <SwiperSlide>
        <img alt="item-4" className="white-img" src="/images/z5.webp" />
        <h4 className="program-header black align-left hmargin w90">Video Consultation</h4>
        <h3 className="text-medium-normal black align-left w90">Professional advice to help you progress.</h3>
    </SwiperSlide>
</Swiper>
            ...
            <div className='portfolio-header-center'>
    <div className='header-wrapper'>
        <p className='text-regular-semibold black section-indicator alignself text-regular-semibold lighter'>Healthy Nutrition</p>
    </div>
    <div className='header-wrapper'>
        <h3 className='heading-desktop-h3 black'>Diverse and Delicious Meal Plans!</h3>
    </div>
    <div className='header-wrapper'>
        <h3 className='text-medium-normal black'>
            Our programs include carefully curated meal plans that are both tasty and healthy.
        </h3>
    </div>
</div>
            ...
            <div className='prednosti-online'>
                <div className='online-roe'>
                    <div className='onl-left'>
                        <img alt='item-1' className='onl-img' src='/images/online3.webp' />

                    </div>
                    <div className='prednosti-onl width-one width-two predspl'>
    <h3 className='heading-desktop-h3 black'>Benefits of Online Coaching</h3>
    <div className='one-bullets-row'>
        <div className='one-bullet'>
            <div className='one-bullet-wrapper'>
                <img src="/images/cool.svg" className='relume-icon' alt='heroes' />
                <h6 className='heading-desktop-h6 highlighted-header'>Convenience and Flexibility</h6>
                <p className='text-regular-normal black'>
                    Enables training at a location that suits you—even from home.
                </p>
            </div>
        </div>
        <div className='one-bullet'>
            <div className='one-bullet-wrapper'>
                <img src="/images/infinite.svg" className='relume-icon' alt='heroes' />
                <h6 className='heading-desktop-h6 highlighted-header'>Access to a Wider Range of Workouts</h6>
                <p className='text-regular-normal black'>
                    We tailor workouts based on your equipment, even for at-home training.
                </p>
            </div>
        </div>
        <div className='one-bullet'>
            <div className='one-bullet-wrapper'>
                <img src="/images/euro.svg" className='relume-icon' alt='heroes' />
                <h6 className='heading-desktop-h6 highlighted-header'>Cost-Effectiveness</h6>
                <p className='text-regular-normal black'>
                    By removing the need for trainer travel, online programs are more affordable.
                </p>
            </div>
        </div>
    </div>
