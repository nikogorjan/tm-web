...
const Enaena = () => {
        ...
        ScrollTrigger.create({
            ...
            onEnter: () => {
                gsap.timeline()
                    ...
                    gsap.timeline()
                    .to(whiteHeaderRef.current, { color: 'black', duration: 0.6 })
                    gsap.timeline()
                    .to(whiteMidRef.current, { color: 'black', duration: 0.6 })
                    gsap.timeline()
                    .to(whiteTextRef.current, { color: 'black', duration: 0.6 })
                    gsap.timeline()
                    .to(iconRef.current, { filter: 'invert(1)', duration: 0.6 }); // Change icon color to black
                    gsap.timeline()
                    ...
                    gsap.timeline()
                    .to(whiteHeaderRef1.current, { color: 'black', duration: 0.6 })
                    gsap.timeline()
                    .to(whiteMidRef1.current, { color: 'black', duration: 0.6 })
                    gsap.timeline()
                    .to(whiteTextRef1.current, { color: 'black', duration: 0.6 })
    ...
    return (
        <div className='ena-main'>
            <div className='ena-wrapper'>
                ...
                <div className='ena-h'>
    <p className='black section-indicator alignself text-regular-semibold smooth' ref={whiteMidRef1}>One-on-One</p>

    <h3 className='heading-desktop-h3' ref={whiteHeaderRef1}>
        We Take You Out of Your Comfort Zone and Deliver Visible Results!
    </h3>
    <p className='text-medium-normal' ref={whiteTextRef1}>
        We dedicate ourselves fully to each client, giving them 100% of our attention.
    </p>
</div>
                </div>
    ...
    <div className='header-wrapper'>
        <p className='text-regular-semibold black section-indicator alignself text-regular-semibold' ref={whiteMidRef}>Team</p>
    </div>
    <div className='header-wrapper'>
        <h3 className='heading-desktop-h3' ref={whiteHeaderRef}>
            We Understand That the Journey is Always Easier Together!
        </h3>
    </div>
    <div className='header-wrapper'>
        <h3 className='text-medium-normal' ref={whiteTextRef}>
            Clients have the opportunity to connect, motivate each other, and share their experiences.
        </h3>
    </div>
</div>
