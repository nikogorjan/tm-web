...
const OnlineHook = () => {
        ...
        <div className='one-first-left'>
            <div className='first-left-wrapper'>
                <h3 className='heading-desktop-h3 black' ref={headerRef1}>
                    Transform Your Body and Mind with Our Range of Services!
                </h3>
            </div>
        </div>
        <div className='one-first-right'>
            <div className='one-right-upper'>
                <p className='text-medium-normal black' ref={textRef1}>
                ...
                <div className='left-row'>
                    <div className='left-row-cell'>
                        <div className='left-row-cell-wrapper' ref={rowRef1}>
                            <img src="/images/dumbbell-black.svg" className='relume-icon' alt='heroes' />
                            <h6 className='heading-desktop-h6 black'>Training</h6>
                            <p className='text-regular-normal black'>Each program includes tailored training based on your goals.</p>
                        </div>
                    </div>
                    <div className='left-row-cell'>
                        <div className='left-row-cell-wrapper' ref={rowReff1}>
                            <img src="/images/restaurant.svg" className='relume-icon' alt='heroes' />
                            <h6 className='heading-desktop-h6 black'>Nutrition</h6>
                            <p className='text-regular-normal black'>In addition to training, programs also include meal plans.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div className='animated-line'>
        ...
        <div className='circle circle1'><span className='circle-text black'>Start Training</span></div>
        <div className='line line2'></div>
        <div className='circle circle2'><span className='circle-text black'>Achieve Goals</span></div>
        <div className='line line3'></div>
        <div className='circle circle3'><span className='circle-text black'>Build Confidence</span></div>
